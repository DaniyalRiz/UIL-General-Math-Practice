...
function App() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "w-12 h-12 mx-auto mb-4 rounded-xl bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/30 flex items-center justify-center text-amber-500 dark:text-amber-400"
  }, /*#__PURE__*/React.createElement("svg", {
    width: "22",
    height: "22",
    viewBox: "0 0 24 24",
  ...
  }, "Open any problem and tap the bookmark icon to save it here for later review."), /*#__PURE__*/React.createElement("button", {
    onClick: function onClick() {
      return setView('list');
    },
  ...
  }, "Browse Problems")) : /*#__PURE__*/React.createElement("div", {
    className: "rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 overflow-hidden shadow-sm"
  }, /*#__PURE__*/React.createElement("div", {
    className: "hidden sm:grid grid-cols-[3rem_1fr_9rem_7rem_11rem_7rem] gap-3 px-4 py-2.5 border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/80 text-xs font-semibold uppercase tracking-wider text-slate-400 dark:text-slate-500"
...
function mountApp() {
  ...
  ReactDOM.createRoot(root).render(/*#__PURE__*/React.createElement(ErrorBoundary, null, /*#__PURE__*/React.createElement(App, null)));
}
